...
const Stat = () => {
  ...
  useEffect(() => {
    if (isVisible) {
      ...
      animateValue(setServersPerMonth, 15, 2000);
      animateValue(setServersPerWeek, "99.9%", 2000);
      animateValue(setTotalUsers, 20, 2000);
    }
  }, [isVisible]);

  return (
    <div className="bg-gray-200 h-auto  w-full dark:bg-gray-700 flex justify-center items-center">
      <div className="max-w-7xl text-center mx-auto px-4 sm:px-6 lg:py-24 lg:px-8" ref={statRef}>
        <h2 className="text-3xl font-bold font-sans tracking-tight text-black sm:text-4xl dark:text-white">Bizim göstəricilərimiz</h2>
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-4 mt-4">
          <div className="bg-white overflow-hidden shadow sm:rounded-lg dark:bg-gray-900">
            <div className="px-4 py-5 sm:p-6">
              <dl>
                <dt className="text-sm leading-5 font-medium text-black truncate dark:text-gray-400">Müştəri</dt>
          ...
          <div className="bg-white overflow-hidden shadow sm:rounded-lg dark:bg-gray-900">
            <div className="px-4 py-5 sm:p-6">
              <dl>
                <dt className="text-sm leading-5 font-medium text-black truncate dark:text-gray-400">Ölkədaxili mağaza</dt>
          ...
          <div className="bg-white overflow-hidden shadow sm:rounded-lg dark:bg-gray-900">
            <div className="px-4 py-5 sm:p-6">
              <dl>
                <dt className="text-sm leading-5 font-medium text-black truncate dark:text-gray-400">İllik təcrübə</dt>
